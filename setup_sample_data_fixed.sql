-- Tạo BCrypt hash cho password "password123"
...
(N'Staff'), 
(N'Customer')
WHERE NOT EXISTS (SELECT 1 FROM [dbo].[Role] WHERE role_name IN (N'Admin', N'Staff', N'Customer'));
GO

-- 2. CHÈN DỮ LIỆU CHO BẢNG Account với BCrypt hash chính xác
...
VALUES 
(N'admin01', N'$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', N'admin@gmail.com', N'Active', 1, N'Nguyễn Quản Trị', N'0901234567'),
(N'staff01', N'$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', N'staff@gmail.com', N'Active', 2, N'Lê Thị Lan', N'0908889999'),
(N'khachhang01', N'$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', N'khach01@gmail.com', N'Active', 3, N'Trần Văn Nam', N'0911223344'),
(N'khachhang02', N'$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', N'khach02@gmail.com', N'Active', 3, N'Phạm Thị Hoa', N'0911556677');
GO
